...
function Projects({ projects }) {
  return (
    <section id="projects" className="relative-container md:space-x-10 px-6 py-10 overflow-hidden bg-gray-900 backdrop-blur-sm flex-col border-t border-b border-gray-700 relative transition-colors" data-aos="fade-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10 " data-aos="fade-up">
