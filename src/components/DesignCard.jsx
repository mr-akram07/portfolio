...
function DesignCard({ sample }) {
    return (
        ...
        >
            <a href={sample.link}><img src={sample.image} alt={sample.title} className="w-full h-48 md:h-55 object-cover" /></a>
            <div className="p-4">
                <h3 className="font-bold text-xl mb-2 hover:text-sky-500"><a href={sample.link}>{sample.title}</a></h3>
