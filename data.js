...
export const projects = [
  { title: "E Commerce Website", link: "https://abs-kohl-nu.vercel.app/", desc: "I created a modern e-commerce website for a local business.", image: "./ECommerce.png", tags: ["Shop Website","E-commerce","Online Store"], },
  { title: "MCQ Test Website", link: "https://mcq-test-portal-liart.vercel.app/", desc: "A website is created for a preparation of any MCQ exam which is managed by admin.", image: "./CCC.png", tags: ["Exam Preparation", "MCQ Tests", "Quick Mock Tests"], },
...
export const designSamples = [
  { title: "Specialized Course Advertisement",  desc: "A Specialized Course Advertisement to attract students for admission.", image: "./BCA.png", link: "./BCA.png",  tags: ["BCA", "Advertisement","Admission Brochure"], },
